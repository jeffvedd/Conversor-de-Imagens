...
'JPG': SaveFormat.JPEG,  // Suporte a JPG
'PNG': SaveFormat.PNG,
...
title: { fontSize: 24, fontWeight: '700', color: '#1e293b', marginTop: 10 },
subtitle: { fontSize: 16, color: '#64748b', marginTop: 5 },
uploadButton: { backgroundColor: '#6366f1', margin: 20, padding: 16, borderRadius: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', elevation: 3 },
uploadText: { color: '#fff', fontSize: 18, fontWeight: '600', marginLeft: 10 },
fileInfo: { backgroundColor: '#fff', marginHorizontal: 20, padding: 16, borderRadius: 12, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0', elevation: 1 },
fileIcon: { backgroundColor: '#ede9fe', padding: 10, borderRadius: 12, marginRight: 15 },
fileDetails: { flex: 1 },
fileName: { fontSize: 16, fontWeight: '600', color: '#1e293b', marginBottom: 5 },
fileType: { fontSize: 14, color: '#64748b' },
section: { margin: 20 },
sectionTitle: { fontSize: 18, fontWeight: '600', color: '#1e293b', marginBottom: 15 },
formatGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
formatButton: { backgroundColor: '#fff', width: (width - 60) / 2, padding: 15, marginVertical: 5, borderRadius: 12, alignItems: 'center', borderWidth: 2, borderColor: '#c7d2fe', elevation: 2 },
formatText: { fontSize: 16, fontWeight: '600', color: '#6366f1', marginTop: 8 },
disabledText: { color: '#94a3b8' },
progressContainer: { alignItems: 'center', padding: 30, margin: 20, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2e8f0', elevation: 2 },
progressText: { marginTop: 15, fontSize: 16, color: '#64748b', marginBottom: 15 },
progressBar: { width: '100%', height: 8, backgroundColor: '#e2e8f0', borderRadius: 4, overflow: 'hidden' },
progressFill: { height: '100%', backgroundColor: '#6366f1', borderRadius: 4 },
progressPercent: { marginTop: 10, fontSize: 14, fontWeight: '600', color: '#6366f1' },
resultContainer: { margin: 20 },
resultTitle: { fontSize: 18, fontWeight: '700', color: '#1e293b', marginBottom: 15, textAlign: 'center' },
resultCard: { backgroundColor: '#fff', padding: 20, borderRadius: 12, flexDirection: 'row', alignItems: 'center', borderWidth: 2, borderColor: '#bbf7d0', elevation: 2 },
resultIcon: { backgroundColor: '#dcfce7', padding: 10, borderRadius: 12, marginRight: 15 },
resultInfo: { flex: 1 },
resultFileName: { fontSize: 16, fontWeight: '600', color: '#1e293b', marginBottom: 5 },
resultFormat: { fontSize: 14, color: '#64748b', marginBottom: 3 },
resultOriginal: { fontSize: 12, color: '#94a3b8' },
saveButton: { backgroundColor: '#10b981', padding: 16, borderRadius: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 15, elevation: 3 },
saveText: { color: '#fff', fontSize: 18, fontWeight: '600', marginLeft: 10 },
});
